...
cart_route.get('/shipping-charge', cartController.calculateShippingCharge);
cart_route.post('/create-razorpay-order', cartController.createRazorpayOrder);
cart_route.post('/create-failed-razorpay-order', cartController.createFailedRazorpayOrder);
cart_route.post('/verify-and-save-order', cartController.verifyAndSaveOrder);
cart_route.post('/verify-and-update-failed-order', cartController.verifyAndUpdateFailedOrder);
